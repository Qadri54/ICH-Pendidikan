...
class SavingLedgerService
{
    ...
    {
        return SavingLedger::with(['teacher.user', 'academicPeriod', 'classRoom'])
    ...
    {
        return SavingLedger::with(['teacher.user', 'academicPeriod', 'classRoom', 'passbooks.student.classRoom'])
            ->findOrFail($ledgerId);
    }
