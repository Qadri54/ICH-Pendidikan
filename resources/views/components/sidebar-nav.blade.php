...
$adminMenu = [
    ...
    ['label' => 'Orang Tua',   'route' => 'admin.user.index',       'icon' => 'user_circle'],
...
$guruMenu = [
    ...
    ['label' => 'Kehadiran',   'route' => 'kehadiran',        'icon' => 'calendar'],
...
@foreach ($menus as $item)
    ...
    <a href="{{ Route::has($item['route']) ? route($item['route']) : '#' }}"
       class="flex flex-col items-center gap-1 w-full px-2 py-2.5 rounded-lg text-center transition-colors
              {{ $isActive
