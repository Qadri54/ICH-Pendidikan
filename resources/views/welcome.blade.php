...
<html lang="id">
    ...
    <head>
        ...
        <link
            href="https://fonts.googleapis.com/css2?family=Poppins:wght@400;500;600;700;800&family=Inter:wght@400;500;600;700&family=Nunito+Sans:wght@400;600;700&family=Raleway:wght@700;800&display=swap"
            rel="stylesheet">
        <style>
            *,
            *::before,
            *::after {
            ...
            .hero-bg {
                position: absolute;
                inset: 0;
                background: url('{{ !empty($hero['image']) ? imgSrc($hero['image']) : asset('images/hero-students.jpg') }}') center/cover no-repeat;
            ...
            .btn-primary {
                ...
                align-items: center;
                gap: 8px;
                box-shadow: 0 4px 16px rgba(61, 167, 70, 0.4);
                transition: transform 0.15s, box-shadow 0.15s;
            }

            .btn-primary:hover {
                transform: translateY(-2px);
                box-shadow: 0 8px 24px rgba(61, 167, 70, 0.45);
            }
            ...
            .stat-icon {
                ...
                height: 52px;
                border-radius: 14px;
                background: rgba(68, 252, 81, 0.18);
                display: flex;
                align-items: center;
                justify-content: center;
                flex-shrink: 0;
            ...
            .prog-card {
                ...
                border-radius: 16px;
                padding: 28px 24px;
                box-shadow: 0 1px 4px rgba(89, 96, 120, 0.1);
            ...
            .prog-card:hover {
                ...
                box-shadow: 0 12px 32px rgba(61, 167, 70, 0.12);
                border-color: #EEF6F0;
            }

            .prog-card.highlighted {
                background: linear-gradient(135deg, #3DA746 0%, #3B8249 100%);
            }

            .prog-card.highlighted .prog-title {
                color: #fff;
            }

            .prog-card.highlighted .prog-desc {
                color: rgba(255, 255, 255, 0.85);
            }

            .prog-card.highlighted .prog-icon {
                background: rgba(255, 255, 255, 0.2);
            }

            .prog-card.highlighted .prog-icon svg {
                stroke: #fff;
            }
            ...
            .act-img-placeholder {
                width: 100%;
                height: 100%;
                background: linear-gradient(135deg, #EEF6F0 0%, #F5F6FA 100%);
                display: flex;
                align-items: center;
                justify-content: center;
            }
            ...
            .cta-box {
                background: linear-gradient(135deg, var(--green) 0%, #3B8249 100%);
                border-radius: 24px;
                padding: 72px 40px;
                max-width: 900px;
                margin: 0 auto;
            ...
            .btn-yellow {
                ...
                align-items: center;
                gap: 8px;
                box-shadow: 0 4px 16px rgba(253, 182, 37, 0.35);
                transition: transform 0.15s;
            }
    ...
    <body>
        ...
        <nav class="nav" id="nav">
            <a href="#" class="nav-logo">
                <div class="mark" style="overflow:hidden;padding:4px;"><img src="{{ asset('images/Logo.png') }}"
                        alt="ICH Logo" style="width:100%;height:100%;object-fit:contain;"></div>
                <div class="wordmark">
        ...
        <div class="mobile-menu">
            <button class="mobile-menu-close"
                onclick="document.querySelector('.mobile-menu').classList.remove('open')">✕</button>
            <a href="#tentang" onclick="document.querySelector('.mobile-menu').classList.remove('open')">Tentang
                Kami</a>
            ...
            <div style="display:flex;flex-direction:column;gap:12px;margin-top:20px;width:80%;max-width:280px;">
                <a href="{{ route('login') }}" onclick="document.querySelector('.mobile-menu').classList.remove('open')"
                    style="display:block;text-align:center;padding:14px 0;border-radius:8px;border:1.5px solid rgba(255,255,255,0.6);background:transparent;color:#fff;font-family:'Inter',sans-serif;font-weight:600;font-size:16px;text-decoration:none;">Masuk</a>
                <a href="{{ route('register') }}"
                    onclick="document.querySelector('.mobile-menu').classList.remove('open')"
                    style="display:block;text-align:center;padding:14px 0;border-radius:8px;border:none;background:#fff;color:var(--teal);font-family:'Inter',sans-serif;font-weight:700;font-size:16px;text-decoration:none;">Daftar</a>
            </div>
        </div>
                    ...
                    <div class="hero-btns">
                        <a href="#program" class="btn-primary">
                            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                ...
                                <path d="M20 4h-7a4 4 0 00-4 4v12h7a4 4 0 004-4z" />
                            </svg>
                            Lihat Program
                        </a>
                ...
                @if(!empty($hero['stats']))
                    <div class="hero-strip">
                        @foreach($hero['stats'] as $stat)
                            <div class="hero-stat">
                                <div class="stat-icon">
                                    <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="#4A9E5C" stroke-width="1.8"
                                        stroke-linecap="round" stroke-linejoin="round">
                                        <path d="M4 4h7a4 4 0 014 4v12H8a4 4 0 01-4-4z" />
                                        <path d="M20 4h-7a4 4 0 00-4 4v12h7a4 4 0 004-4z" />
                                    </svg>
                                </div>
                                <div class="stat-text"><strong>{{ $stat['title'] }}</strong><span>{{ $stat['subtitle'] }}</span>
                                </div>
                            </div>
                        @endforeach
                    </div>
        ...
        @if(isset($sections['tentang']))
            <section class="about" id="tentang">
                <div class="about-grid">
                    <div class="about-img">
                        <img src="{{ imgSrc($tentang['image'] ?? '') }}" alt="Kegiatan belajar siswa ICH" loading="lazy"
                    ...
                    <div>
                        ...
                        <p
                            style="font-family:'Inter',sans-serif;font-size:15px;color:#687182;line-height:1.75;margin-bottom:24px;">
                            {{ $tentang['description'] ?? '' }}
                        </p>
                            ...
                            <div class="about-features">
                                @foreach($tentang['features'] as $feat)
                                    <div class="about-feat">
                                        <div class="dot">
                                            <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="#4A9E5C"
                        ...
                        <a href="{{ route('register') }}" class="btn-primary"
                            style="margin-top:32px;display:inline-flex;">Daftar Sekarang</a>
                    </div>
                </div>
            </section>
        @endif
                    ...
                    <div class="programs-grid">
                        @foreach(($program['items'] ?? []) as $item)
                            <div class="prog-card {{ !empty($item['highlighted']) ? 'highlighted' : '' }}">
                                <div class="prog-icon">
                                    <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="#4A9E5C"
                    ...
                    <div class="acts-grid">
                        @foreach(($aktivitas['items'] ?? []) as $act)
                            <div class="act-card">
                                <div class="act-img">
                                    @if(!empty($act['image']))
                                        <img src="{{ imgSrc($act['image']) }}" alt="{{ $act['title'] }}" loading="lazy"
                                    ...
                                    @else
                                        <div class="act-img-placeholder">
                                            <svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="#4A9E5C"
                                                stroke-width="1.5">
                    ...
                    <div class="testi-grid">
                        @foreach(($testimoni['items'] ?? []) as $item)
                            <div class="testi-card">
                                <div class="testi-stars"><span>★</span><span>★</span><span>★</span><span>★</span><span>★</span>
                                </div>
                                <p class="testi-text">"{{ $item['text'] }}"</p>
                                <div class="testi-author">
                                    <div class="testi-avatar">
                                        @if(!empty($item['avatar']))
                                            <img src="{{ imgSrc($item['avatar']) }}" alt="{{ $item['name'] }}"
                                                onerror="this.outerHTML='<span>{{ mb_strtoupper(mb_substr($item['name'], 0, 1)) }}</span>'">
                                        @else
                ...
                <div class="cta-box">
                    ...
                    <div class="cta-btns">
                        <a href="https://wa.me/{{ $cta['whatsapp'] ?? '6281360765971' }}" target="_blank" class="btn-white">
                            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#4A9E5C" stroke-width="2.5"
                                stroke-linecap="round" stroke-linejoin="round">
                                <path
        ...
        <footer id="kontak">
                    ...
                    <div class="socials">
                        <a href="#">
                            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#fff" stroke-width="2"
                                ...
                                <path d="M16 8a6 6 0 01-8 8 6 6 0 010-8" />
                    ...
                    <ul>
                        ...
                        @if(!empty($footer['whatsapp']))
                            <li style="margin-top:8px;">
                                <a href="https://wa.me/{{ $footer['whatsapp'] }}" target="_blank" rel="noopener"
                                    style="display:inline-flex;align-items:center;gap:6px;background:#25D366;color:#fff;padding:8px 14px;border-radius:8px;font-weight:600;font-size:12px;text-decoration:none;">
            ...
            <div class="footer-bottom">
                <span>Copyright &copy; {{ date('Y') }} {{ $footer['copyright'] ?? "IQRA' CREATIVE GROUP" }}. All Rights
                    Reserved.</span>
