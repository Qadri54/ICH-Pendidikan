...
<title>ICH Pendidikan – IQRA' Creative House</title>
...
<style>
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .hero-wash { position: absolute; inset: 0; background: #3DA746; opacity: 0.3; }
  ...
  .hero-badge::before { content: ''; width: 8px; height: 8px; border-radius: 50%; background: #FDB625; }
  ...
  .about-feat .dot { width: 22px; height: 22px; border-radius: 50%; background: #E8F5EA; display: flex; align-items: center; justify-content: center; flex-shrink: 0; margin-top: 1px; }
  ...
  .prog-card:hover { transform: translateY(-4px); box-shadow: 0 12px 32px rgba(61,167,70,0.12); border-color: #E8F5EA; }
  ...
  .act-img-placeholder { width: 100%; height: 100%; background: linear-gradient(135deg, #E8F5EA 0%, #F5F6FA 100%); display: flex; align-items: center; justify-content: center; }
  .act-body { padding: 20px; background: #fff; }
  .act-tag { display: inline-flex; align-items: center; padding: 3px 10px; border-radius: 999px; background: #E8F5EA; color: var(--green); font-family: 'Nunito Sans', sans-serif; font-weight: 700; font-size: 11px; margin-bottom: 10px; }
  ...
  .cta-box { background: linear-gradient(135deg, var(--green) 0%, #2F8537 100%); border-radius: 24px; padding: 72px 40px; max-width: 900px; margin: 0 auto; position: relative; overflow: hidden; }
...
<div class="mobile-menu">
  ...
  <a href="{{ route('login') }}" onclick="document.querySelector('.mobile-menu').classList.remove('open')" style="color:#FDB625">Masuk / Daftar</a>
</div>
...
<section class="hero" id="beranda">
  ...
  <div class="hero-strip">
    <div class="hero-stat">
      <div class="stat-icon">
        <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="#3DA746" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M4 4h7a4 4 0 014 4v12H8a4 4 0 01-4-4z"/><path d="M20 4h-7a4 4 0 00-4 4v12h7a4 4 0 004-4z"/></svg>
      </div>
      <div class="stat-text"><strong>Belajar Al-Qur'an</strong><span>Mengaji, Tahsin &amp; Tahfidz</span></div>
    </div>
    <div class="hero-stat">
      <div class="stat-icon">
        <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="#3DA746" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M12 3l10 5-10 5L2 8z"/><path d="M6 10v5c0 2 3 3 6 3s6-1 6-3v-5"/></svg>
      </div>
      <div class="stat-text"><strong>Program Terstruktur</strong><span>Kurikulum Islami Terintegrasi</span></div>
    </div>
    <div class="hero-stat">
      <div class="stat-icon">
        <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="#3DA746" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><circle cx="9" cy="8" r="3.5"/><path d="M3 20c0-3 3-5 6-5s6 2 6 5"/><circle cx="17" cy="9" r="2.5"/><path d="M15 20c0-2 2-3.5 4-3.5s2.5 1 2.5 2"/></svg>
      </div>
    ...
    <div>
      ...
      <div class="about-features">
        <div class="about-feat">
          <div class="dot">
            <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="#3DA746" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12l5 5L20 7"/></svg>
          </div>
...
<section class="programs" id="program">
  <div class="programs-inner">
    ...
    <div class="programs-grid">
      ...
      <div class="prog-card">
        <div class="prog-icon">
          <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="#3DA746" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M12 3l2.7 5.5 6 .9-4.3 4.2 1 6L12 17l-5.4 2.6 1-6L3.3 9.4l6-.9z"/></svg>
        </div>
      ...
      <div class="prog-card">
        <div class="prog-icon">
          <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="#3DA746" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="9"/><path d="M12 7v5l3 2"/></svg>
        </div>
      ...
      <div class="prog-card">
        <div class="prog-icon">
          <svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="#3DA746" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M3 3v18h18 M7 15l4-4 3 3 5-6"/></svg>
        </div>
      ...
      <div class="prog-card" style="background:linear-gradient(135deg,#3DA746 0%,#2F8537 100%);">
        ...
        <div class="act-img">
          ...
          @else
            <div class="act-img-placeholder">
              <svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="#3DA746" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><path d="M4 20h4l11-11-4-4L4 16z"/></svg>
            </div>
          @endif
        </div>
        <div class="act-body">
  ...
  <div class="cta-box">
    ...
    <div class="cta-btns">
      <a href="#kontak" class="btn-white">
        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#3DA746" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M5 4h4l2 5-2.5 1.5a11 11 0 005 5L15 13l5 2v4a2 2 0 01-2 2A16 16 0 013 6a2 2 0 012-2z"/></svg>
        Hubungi Kami
      </a>
    ...
    <div class="footer-col">
      ...
      <ul>
        ...
        <li style="margin-top:8px;">
          <a href="#" style="display:inline-flex;align-items:center;gap:6px;background:#25D366;color:#fff;padding:8px 14px;border-radius:8px;font-weight:600;font-size:12px;text-decoration:none;">
